...
class PaycorpService
{
    ...
    {
        $this->endpoint = config('services.paycorp.endpoint');
        $this->clientId = config('services.paycorp.client_id');
        $this->authToken = config('services.paycorp.auth_token');
        $this->hmacSecret = config('services.paycorp.hmac_secret');
    }
